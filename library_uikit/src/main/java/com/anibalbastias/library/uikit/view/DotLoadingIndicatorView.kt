package com.anibalbastias.library.uikit.view
...
import com.anibalbastias.library.uikit.extension.dpToPx
...
class DotLoadingIndicatorView : View {
    ...
    private var squareWidth: Int =
        dpToPx(BACKGROUND_SQUARE_WIDTH)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        dotRadius = dpToPx(DOT_RADIUS)
            .toFloat()
        spacing = dpToPx(SPACING)
            .toFloat()
